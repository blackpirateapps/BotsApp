const data = {
  ...
  setdp: {
      ...
      NOT_A_GROUP: "```This command is only applicable in a group chat.```",
      ICON_CHANGED: "```Chnaging icon/group image, blink twice...```"
  },
  song: {
  ...
  sticker: {
      ...
      DOWNLOADING: "```Your sticker is downloading. Breathe...```"
  },
  stoi: {
      ...
      ANIMATED_STICKER_ERROR : "```Shit, Tagged sticker message is animated, ``` *Can not convert animated sticker to image*, ```Try again with a static sticker, Please.```",
      TAG_A_VALID_STICKER_MESSAGE:
          "```Please tag a valid sticker message to convert to an image.```",
      DOWNLOADING: "```Your image is downloading. Inhale & exhale...```",
